...
ggplot(pima_bp, aes(x=BP, fill=factor(RESPONSE))) +
  geom_density(alpha=0.5) + ylab("Density") + xlab("Diastolic Blood Pressure") + ggtitle("Relationship between Diabetic and Non-Diabetic Groups and Blood Pressure") + scale_fill_manual(legend_title, values=c("Green","Red"))
```
